     ...
     <div class=" " tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
               <div class="modal-content">
                    ...
                    <div class="modal-body">
                         <form id="contact-form">
                              <div class="row">
								...
								<!-- <label for="location">Choose Pickup Location</label> -->
                                        ...
                                        <option value="Pachpaoli">Pachpaoli</option>
                                        ...
                                        <option value="Shraddhanand Peth">Shraddhanand Peth</option>
                                        <option value="Sitabuldi">Sitabuldi</option>
                                        <option value="Vayusena Nagar">Vayusena Nagar</option>
                                   ...
                                   <div class="col-md-6">
                                   <label>Choose Return Location</label>
                                   <select name="location" id="location">
                                        <option value="Abhyankar Nagar">Abhyankar Nagar</option>
                                        <option value="Ajni">Ajni</option>
                                        <option value="Ayodhya Nagar">Ayodhya Nagar</option>
                    ...
                    </div><center><form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_HSTcg9YyYTtwrl" async> </script> </form></center>
